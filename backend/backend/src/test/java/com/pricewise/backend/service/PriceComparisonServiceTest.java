...
class PriceComparisonServiceTest {
    ...
    void setUp() {
        ...
        priceComparisonService = new PriceComparisonService(priceRecordRepository, storeProductRepository);
    }
    ...
    void testPriceComparisonCalculations() {
        ...
        when(storeProductRepository.findByProductId(10L)).thenReturn(java.util.List.of(amazon, flipkart, croma, unavail));
